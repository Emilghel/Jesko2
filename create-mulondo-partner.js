/**
 * Create Mulondo Partner Account with Known Password
 * 
 * This script creates or updates a partner account with the email mulondo@partner.com
 * and a known password.
 */
...
async function createMulondoPartner() {
  try {
    console.log("Creating or updating Mulondo partner account...");
    
    // Fixed login credentials - for testing only
    const email = 'mulondo@partner.com';
    const password = 'testpassword123';
    const displayName = 'Mulondo Partner';
    const companyName = 'Mulondo Solutions';
    ...
    if (result.rows.length === 0) {
      ...
      const referralCode = 'MULONDO2025';
      ...
      const partnerResult = await pool.query(
        ...
        [
          ...
          0, // initial earnings
          0, // total earnings
          'https://mulondosolutions.com',
          'Mulondo Solutions - Test Partner Account'
        ]
      );
    ...
    console.log("\nMulondo Partner Account Setup Complete:");
    console.log("========================================");
    ...
    console.error('Error creating Mulondo partner:', error);
  } finally {
